...
CREATE TABLE `t_blog_category` (
  ...
  `alias` varchar(100) DEFAULT NULL COMMENT '分类显示名',
  ...
  `alive_flag` varchar(1) DEFAULT '1' COMMENT '是否存活，1 存活，0 已删除',
  PRIMARY KEY (`ID`)
...
CREATE TABLE `t_blog` (
  ...
  `summary` varchar(200) NOT NULL COMMENT '博客摘要',
  `content` longtext DEFAULT NULL COMMENT '博客内容',
  `content_html` longtext DEFAULT NULL COMMENT '博客内容HTML',
  `author` varchar(32) NOT NULL COMMENT '作者',
  `tag` varchar(200) DEFAULT NULL COMMENT '标签',
  `status` varchar(8) DEFAULT NULL COMMENT '状态：0 草稿，1 发布',
...
INSERT INTO `blog_content` VALUES ('75', 'Hello, World! ', null, null, null, 'Hello, World! Hello, World! Hello, World! ', 'article', null, null, null, null, '0', '0', '1', '1', 'iWorld', '2017-09-22 14:44:44', '2017-09-22 14:44:44');
INSERT INTO `blog_content` VALUES ('76', 'Hello, World! ', null, null, null, 'Hello, World! Hello, World! Hello, World! ', 'article', null, 'about', null, null, '0', '0', '1', '1', 'iWorld', '2017-09-22 14:44:44', '2017-09-22 14:44:44');
INSERT INTO `blog_content` VALUES ('77', 'Hello, World! ', null, null, null, 'Hello, World! Hello, World! Hello, World! ', 'article', null, 'communication', null, null, '0', '0', '1', '1', 'iWorld', '2017-09-22 14:44:44', '2017-09-22 14:44:44');
...
INSERT INTO `sys_file` VALUES ('110', '0', '/images/default-avatar.jpg', '2017-10-14 16:20:17');
INSERT INTO `sys_file` VALUES ('111', '0', '/images/default-avatar.jpg', '2017-10-14 16:20:21');
INSERT INTO `sys_file` VALUES ('114', '0', '/images/default-avatar.jpg', '2017-10-20 09:27:18');
INSERT INTO `sys_file` VALUES ('118', '0', '/images/default-avatar.jpg', '2017-10-20 11:53:52');
INSERT INTO `sys_file` VALUES ('132', '0', '/images/default-avatar.jpg', '2017-12-18 20:19:51');
INSERT INTO `sys_file` VALUES ('134', '0', '/images/default-avatar.jpg', '2017-12-18 22:44:07');
INSERT INTO `sys_file` VALUES ('138', '0', '/images/default-avatar.jpg', '2017-12-19 19:55:27');
INSERT INTO `sys_file` VALUES ('139', '0', '/images/default-avatar.jpg', '2018-01-02 19:53:24');
...
INSERT INTO `sys_menu` VALUES ('98', '97', '测试测试', 'http://bing.com', '', '1', 'fa fa-area-chart', null, null, null);
INSERT INTO `sys_menu` VALUES ('99', '96', '所有权限', '', 'act:process', '2', '', null, null, null);
INSERT INTO `sys_menu` VALUES ('93', '0', '测试测试', '', '', '0', 'fa fa-print', '6', null, null);
INSERT INTO `sys_menu` VALUES ('96', '93', '百度', 'http://www.baidu.com', '', '1', 'fa fa-flag', null, null, null);
INSERT INTO `sys_menu` VALUES ('101', '93', 'Bing', 'http://bing.com', '', '1', '', null, null, null);
