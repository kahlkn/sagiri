...
CREATE TABLE `t_event_record` (
  ...
  `distinct_id` varchar(32) NOT NULL DEFAULT '' COMMENT '用户ID',
  `anonymous_id` varchar(32) NOT NULL DEFAULT '' COMMENT '匿名ID',
  `client_id` varchar(40) NOT NULL DEFAULT '' COMMENT '客户端ID',
  `client_app_id` varchar(40) NOT NULL DEFAULT '' COMMENT '客户端应用的ID',
  `client_device_id` varchar(40) NOT NULL DEFAULT '' COMMENT '客户端设备的ID',
  `client_user_agent` varchar(500) NOT NULL DEFAULT '' COMMENT '客户端用户代理',
  `client_net_address` varchar(60) NOT NULL DEFAULT '' COMMENT '客户端网络地址',
